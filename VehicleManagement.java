...
public class VehicleManagement {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    addVehicle(vehicleList, qwe);
                    break;
                case 2:
                    displayVehicleList(vehicleList);
                    break;
                case 3:
                    deleteVehicle(vehicleList, qwe);
                    break;
                case 4:
                    sortVehicleListByAge(vehicleList, qwe);
                    break;
                case 5:
   ...
   public static void addVehicle(ArrayList<Vehicle> vehicleList, Scanner qwe) {
      System.out.print("Enter Registration number: ");
      String regNo = qwe.nextLine();
      System.out.print("Enter manufacturer: ");
      String make = qwe.nextLine();
      System.out.print("Enter year of manufacture: ");
      int yearOfManufacture = qwe.nextInt();
      System.out.print("Enter value: ");
      double value = qwe.nextDouble();
      qwe.nextLine();
   ...
   public static void deleteVehicle(ArrayList<Vehicle> vehicleList, Scanner qwe) {
      if (vehicleList.isEmpty()) {
         System.out.print("\n\n");
   ...
   public static void sortVehicleListByAge(ArrayList<Vehicle> vehicleList, Scanner qwe) {
      if (vehicleList.isEmpty()) {
         System.out.print("\n\n");
